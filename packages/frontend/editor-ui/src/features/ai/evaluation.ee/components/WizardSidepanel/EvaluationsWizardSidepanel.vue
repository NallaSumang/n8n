...
const titleKey = computed(() => {
	if (activeStep.value === 0) return 'evaluations.wizardSidepanel.step.chooseSystem.title';
	if (activeStep.value === 1) return 'evaluations.wizardSidepanel.step.setupChecks.title';
	if (activeStep.value === 2) return 'evaluations.wizardSidepanel.step.addTestCases.title';
	return 'evaluations.wizardSidepanel.step.results.title';
});

const descriptionKey = computed(() => {
	if (activeStep.value === 0) return 'evaluations.wizardSidepanel.step.chooseSystem.description';
	if (activeStep.value === 1) return 'evaluations.wizardSidepanel.step.setupChecks.description';
	if (activeStep.value === 2) return 'evaluations.wizardSidepanel.step.addTestCases.description';
	return 'evaluations.wizardSidepanel.step.results.description';
});
